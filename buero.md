...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-no-padding col-no-right-padding">
                ...
                <div class="col-dyn-right col-no-padding">
                    <div id="content" class="container-fluid">
                        ...
                        <div class="row row-first">
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-4 col-no-padding">
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-8 col-with-padding right textcontent">
                                ...
                                <div itemscope itemtype="http://schema.org/LocalBusiness">
									...
									<address itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
										...
										Telefon: <a href="tel:++493061676920">+49 (0)30 616 76 92-0</a><br/>
										Telefax: +49 (0)30 616 76 92-30
                                </div>
...
{% for post in site.categories.team %}
                                    ...
                                    <div class="item{% if counter == 0 %} active{% endif %}{% if counter == 0 %} {% endif %}{% if counter == 1 %} {% endif %}">
										<div class="container-fluid">
											...
											<div class="row">
												<div class="col-xs-12 col-md-6 col-lg-4 col-with-padding left textcontent">
													<div>
															...
															<p>
																<a href="#" onclick="$('#carousel-teamakt').carousel('next'); return false;"><span class="icon icon-arr-e">&nbsp;</span> {% if counter == 0 %} Aktivitäten{% endif %}</a>
															</p>
													</div>
												</div>
												<div class="col-xs-12 col-md-6 col-md-offset-6 col-lg-8 col-lg-offset-4 col-no-padding">

													<a href="#" class="nextcursor" onclick="$('#carousel-teamakt').carousel('next'); return false;"><img class="img-responsive" src="{% if site.mode contains 'dev' %}{% else %}http://res.cloudinary.com/{{site.cloudinaryaccount}}/image/fetch/w_600,h_400,c_fill,q_88,f_auto,fl_progressive,fl_force_strip/{% endif %}{{ post.image | prepend: site.url }}"/></a>
...
{% endfor %}
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="visible-xs-inline-block visible-sm-inline-block"><a href="#" onclick="$('#carousel-partner').carousel(0); $('#carousel-partner').carousel('pause'); return false;">Partner</a></h3>
                            </div>
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="item active">
										<div class="container-fluid">
											<div class="row">
												...
												<div class="col-xs-12 col-md-6 col-lg-8 col-with-padding right textcontent">
													<div>
														<h3 class="hidden-xs hidden-sm">Partner</h3>
														<p>
                                    ...
                                    <div class="item">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-12 col-md-6 col-lg-4 col-no-padding">
													<a href="#" class="backcursor" onclick="$('#carousel-partner').carousel(0); $('#carousel-partner').carousel('pause');return false;"><img class="img-responsive" src="{% if site.mode contains 'dev' %}{% else %}http://res.cloudinary.com/{{site.cloudinaryaccount}}/image/fetch/w_600,h_400,c_fill,q_88,f_auto,fl_progressive,fl_force_strip/{% endif %}{{site.url}}/buero/partner/02_ArthurNumrich.jpg" /></a>
                                                    <p class="left-right-buttons">
                                                    	<a href="#" onclick="$('#carousel-partner').carousel(0); $('#carousel-partner').carousel('pause');return false;"><span class="icon icon-arr-w">&nbsp;</span></a>
                                                    	&nbsp;
												...
												<div class="col-xs-12 col-md-6 col-lg-8 col-with-padding right">
														<p>
                                    ...
                                    <div class="item">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-12 col-md-6 col-lg-4 col-no-padding">
													<a href="#" class="backcursor" onclick="$('#carousel-partner').carousel(0); $('#carousel-partner').carousel('pause');return false;"><img class="img-responsive" src="{% if site.mode contains 'dev' %}{% else %}http://res.cloudinary.com/{{site.cloudinaryaccount}}/image/fetch/w_600,h_400,c_fill,q_88,f_auto,fl_progressive,fl_force_strip/{% endif %}{{site.url}}/buero/partner/03_TiemoKlumpp.jpg" /></a>
                                                    <p class="left-right-buttons">
                                                    	<a href="#" onclick="$('#carousel-partner').carousel(0); $('#carousel-partner').carousel('pause');return false;"><span class="icon icon-arr-w">&nbsp;</span></a>
                                                    	&nbsp;
                                    ...
                                    <div class="item">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-12 col-md-6 col-lg-4 col-no-padding">
													<a href="#" class="backcursor" onclick="$('#carousel-partner').carousel(0); $('#carousel-partner').carousel('pause');return false;"><img class="img-responsive" src="{% if site.mode contains 'dev' %}{% else %}http://res.cloudinary.com/{{site.cloudinaryaccount}}/image/fetch/w_600,h_400,c_fill,q_88,f_auto,fl_progressive,fl_force_strip/{% endif %}{{site.url}}/buero/partner/04_GarntKelly.jpg" /></a>
                                                    <p class="left-right-buttons">
                                                    	<a href="#" onclick="$('#carousel-partner').carousel(0); $('#carousel-partner').carousel('pause');return false;"><span class="icon icon-arr-w">&nbsp;</span></a>
                                                    	&nbsp;
